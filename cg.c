...
char s2[100]="VIVEKANANDA COLLEGE OF ENGINEERING AND TECHNOLOGY";
char s3[150]="DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING";
char s4[20]="A Mini Project On:-";
char s5[20]="AEROPLANE CRASH";
char s6[200]="BY- VIDYARATHNA B & SPARSHA SHETTY G";
...
glutCreateWindow("DEMOLITION OF A BUILDING BY AEROPLANE CRASH");
